...
public class main_sc {
	...
	void addWashplan()
	{
		Scanner sc = new Scanner(System.in);
 		...
 		System.out.println("Enter number of washes:");
 		int noWash=Integer.parseInt(sc.nextLine());
 		System.out.println("Enter plan Code");
 		String code=sc.nextLine();
 		System.out.println("Enter max weight:");
 		int maxWeight=Integer.parseInt(sc.nextLine());
 		washplans.add(new Washplan(cost,noWash,code,maxWeight));
 		System.out.println("Wash Plan added successfully");
	}
	...
	void schedule()
 	...
 	public static void main( String args[]) throws FileNotFoundException, IOException, ClassNotFoundException 
	 {
        ...
        nt.t.start();// multithreading can be used when this program is converted into one with real life usage where multiple users have to enter data simultaneously
		 ...
		 Scanner sc = new Scanner(System.in);
		 	...
		 	do
		 	{
		 		...
		 		if(adminlogged==true)
		 		{
		 			...
		 			if(choice.equals("HA"))
		 			{
		 				new main_sc().addHostel();
		 				flag=1;
		 			}
		 			
		 			if(choice.equals("WA"))
		 			{
		 				new main_sc().addWashplan();
		 				flag=1;
		 			}
		 			if(choice.equals("L2"))
			 		{
