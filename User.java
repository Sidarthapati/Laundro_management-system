...
public class User implements Serializable{
	...
	void addWash(Wash lo)
	{
		...
		{
			lo.extraprice=(lo.weight)*120;
			System.out.println("Extra cost has been charged for exceeding wash number");
		}
		...
		System.out.println("Laundry will be delivered at"+ hos.time ); 
	}
